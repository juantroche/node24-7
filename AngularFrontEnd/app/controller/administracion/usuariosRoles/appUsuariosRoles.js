app.factory("servicesUsuarioRol", ['$http', function($http) {
...
app.controller('UsuariosRolesController', function ($scope,servicesUsuarioRol) {
    servicesUsuarioRol.getUsuariosRoles2().then(function(data){
