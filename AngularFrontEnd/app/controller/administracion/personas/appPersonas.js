app.factory("servicesPersona", ['$http', function($http) {
...
app.controller('PersonasController', function ($scope,servicesPersona) {
    ...
    $scope.GuardarAnimal = function(animal){
      servicesPersona.insertarPersona(animal);
    }
    ...
    $scope.modificarAnimal = function(animal){
      servicesPersona.modificarPersona(animal);
    }
});
